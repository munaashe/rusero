  ...
  return (
    <div id="portfolio" style={{ background: "#fafafa" }}>
      <Container maxWidth="lg" sx={{ marginTop: "30px" }}>
        ...
        <Grid container spacing={2}  justifyContent="space-evenly"  style={{paddingBottom: '32px'}}>
          <Grid item xs={12} sm={6} md={4} lg={4} height="120px">
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <Grid item xs={12} sm={6} md={4} lg={4} height="180px">
            <a target="_blank" rel="noreferrer" href="https://sn-eng.co.zw/">
              <Card
                sx={{
                  display: "flex",
                  backgroundColor: "transparent",
          ...
          <Grid item xs={12} sm={6} md={3} lg={3} height="120px">
